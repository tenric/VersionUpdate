...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "tenric"
  # s.authors            = { "tenric" => "minjieni@vip.qq.com" }
  # s.social_media_url   = "http://twitter.com/tenric"
  ...
  s.source       = { :git => "https://github.com/tenric/VersionUpdate.git", :tag => s.version }
